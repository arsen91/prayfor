            ...
            '<div class="panel-group" id="accordion">'+
              ...
              '<div class="panel panel-default">'+
                ...
                '<div id="organizers" class="panel-collapse collapse">'+
                  '<div class="panel-body">'+
                    '<p>Объединенная команда служителей из мессианской еврейской общины "Новый Завет", церкви ХВЕ "Христианская Надежда" молодёжный пастор Евгений Горёлик и церкви ЕХБ "Спасение во Христе" лидер прославления Андрей Устинов.</p>'+
                  '</div>'+
                '</div>'+
              '</div>'+
            '</div>'+
