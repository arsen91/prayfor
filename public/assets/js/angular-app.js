angular.module('molitva', ['ngRoute'])
    ...
    .component('navigation', {
        ...
        template: '<nav>' +
                ...
                "<script>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){  (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)  })(window,document,'script','https://www.google-analytics.com/analytics.js','ga');  ga('create', 'UA-89740605-1', 'auto');  ga('send', 'pageview');</script>" +
            '</nav>'
    })
            ...
            '</div>'+
              '<div class="panel panel-default">'+
                ...
                '<div id="aboutConf" class="panel-collapse collapse">'+
                  '<div class="panel-body">'+
                    ...
                    '<p class="knowmore-section-text">Мы чем-то можем отличаться друг от друга, но мы все Одно Тело, мы можем по-разному выражать свое поклонение Богу, но у всех нас Один Господь, Одно Слово и мы все держимся на Одном корне! Вместе мы можем больше!</p>'+
                  '</div>'+
                '</div>'+
              '</div>'+
              ...
              '<div class="panel panel-default">'+
                ...
                '<div id="programm" class="panel-collapse collapse">'+
                  '<div class="panel-body">'+
                    '<p class="knowmore-section-text">Вся программа направлена на достижение видения конференции и состоит из блоков. Каждый из них включает прославление и поклонение с участием команд из разных церквей, тематическое Слово и молитву.</p>'+
                    '<p class="knowmore-section-text">Все вместе в субботу мы отпразднуем Шабат с еврейским прославлением и хороводами - это самый первый Божий праздник, который Господь заповедал соблюдать Своему народу через Моисея (Левит 23:1-3). Мы верим, Господь повел нас после Шабата сделать специальный молодежный блок с фокусом не просто на единство среди молодежи разных церквей, но также на единство ПОКОЛЕНИЙ в поместных церквях и общинах!</p>'+
                    '<hr>'+
                  ...
                  '<div class="panel-body">'+
                    '<ul class="speackers-content">'+
                        ...
                        '<li>'+
                            ...
                            '</div>'+
                            '<p class="speacker-name"><b>Войнилович Михаил Владимирович</b> - 1-й заместитель епископа Объединения ХВЕ в г. Минске и Минской области</p>'+
                        '</li>'+
                        ...
                        '<li>'+
                            ...
                            '</div>'+
                            '<p class="speacker-name"><b>Виталий Кондрат</b> - старейшина Еврейской Мессианской общины "Брит Хадаша" г. Минск</p>'+
                        '</li>'+
                        ...
                        '<li>'+
                            ...
                            '</div>'+
                            '<p class="speacker-name"><b>Роман Зенькович</b> - старейшина Еврейской Мессианской общины "Брит Хадаша" г. Минск</p>'+
                        '</li>'+
                  ...
                  '<div class="panel-body">'+
                    ...
                    '<ul class="speackers-content">'+
                        '<li>'+
                            ...
                            '</div>'+
                            '<p class="speacker-name"><b>Алексей Берёзкин</b> - молодёжный служитель, община "Брит Хадаша" г. Минск</p>'+
                        '</li>'+
                        ...
                        '<li>'+
                            ...
                            '</div>'+
                            '<p class="speacker-name"><b>Евгений Горелик</b> - молодёжный пастор, церковь "Христианская Надежда" г. Минск</p>'+
                        '</li>'+
                        ...
                        '<li>'+
                            ...
                            '</div>'+
                            '<p class="speacker-name"><b>Андрей Павлович</b> - молодёжный пастор, церковь "Иисуса Христа" г. Минск</p>'+
                        '</li>'+
                    '</ul>'+
